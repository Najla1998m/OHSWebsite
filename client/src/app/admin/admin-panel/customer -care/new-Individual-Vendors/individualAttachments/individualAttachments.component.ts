...
@Component({
  selector: 'app-individualAttachments',
  templateUrl: './individualAttachments.component.html',
  styleUrls: ['./individualAttachments.component.css'],
})
export class IndividualAttachmentsComponent implements OnInit {
  listAttach: any[] = [];
  listRejects: any[] = [];
  ...
  taskId: any;
  constructor(
    private attachService: IndividualAttachmentsService,
