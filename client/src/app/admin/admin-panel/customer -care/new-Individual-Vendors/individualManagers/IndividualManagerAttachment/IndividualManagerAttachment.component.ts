...
@Component({
  selector: 'app-IndividualManagerAttachment',
  templateUrl: './IndividualManagerAttachment.component.html',
  styleUrls: ['./IndividualManagerAttachment.component.css'],
})
export class IndividualManagerAttachmentComponent implements OnInit {
  listAttach: any[] = [];
  listRejects: any[] = [];
