...
@Component({
  selector: 'app-companyAttachments',
  templateUrl: './companyAttachments.component.html',
  styleUrls: ['./companyAttachments.component.css'],
})
export class CompanyAttachmentsComponent implements OnInit {
  listAttach: any[] = [];
  listRejects: any[] = [];
