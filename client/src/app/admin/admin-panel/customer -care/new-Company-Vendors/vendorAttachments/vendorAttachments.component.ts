...
@Component({
  selector: 'app-vendorAttachments',
  templateUrl: './vendorAttachments.component.html',
  styleUrls: ['./vendorAttachments.component.css'],
})
export class VendorAttachmentsComponent implements OnInit {
  listAttach: any[] = [];
  listRejects: any[] = [];
  ...
  taskId: any;
  constructor(
    private attachService: VendorAttachmentService,
