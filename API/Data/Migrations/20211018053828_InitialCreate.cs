...
namespace API.Data.Migrations
{
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "CancelSubscriptionReasons",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CancelSubscriptionReasons", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmployeesNumbers = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PackageCriterias", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsVisible = table.Column<bool>(type: "bit", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    ForVendors = table.Column<bool>(type: "bit", nullable: false),
                    ForClients = table.Column<bool>(type: "bit", nullable: false),
                    EmployeesNumbers = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_QuestionsPages", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Image = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AltHeadline = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AltBody = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TasksLevels", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WizardTypes", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CorrespondingDeptId = table.Column<int>(type: "int", nullable: true),
                    UnitType = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DepartementLocation = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsEmployeeExpired = table.Column<bool>(type: "bit", nullable: false),
                    IsDateExpired = table.Column<bool>(type: "bit", nullable: false),
                    ChargeDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Duration = table.Column<int>(type: "int", nullable: false),
                    EmployeesNumbers = table.Column<int>(type: "int", nullable: false),
                    PackageAllowedDays = table.Column<int>(type: "int", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    CompanyId = table.Column<int>(type: "int", nullable: false),
                    FullName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IsTeamManager = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "SubscriptionTypeAttachmentMappings",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SubscriptionTypeAttachmentMappings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SubscriptionTypeAttachmentMappings_Attachments_AttachmentId",
                        column: x => x.AttachmentId,
                        principalTable: "Attachments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SubscriptionTypeAttachmentMappings_SubscriptionTypes_SubscriptionTypeId",
                        column: x => x.SubscriptionTypeId,
                        principalTable: "SubscriptionTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SubscriptionTypesTerms", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SubscriptionTypesTerms_SubscriptionTypes_SubscriptionTypeId",
                        column: x => x.SubscriptionTypeId,
                        principalTable: "SubscriptionTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    WizardTypeId = table.Column<int>(type: "int", nullable: false),
                    Title = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Wizards_WizardTypes_WizardTypeId",
                        column: x => x.WizardTypeId,
                        principalTable: "WizardTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsVisible = table.Column<bool>(type: "bit", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    ForContact = table.Column<bool>(type: "bit", nullable: false),
                    ForOrders = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Categories_Departements_DepartementId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    TasksLevelId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Tasks_Departements_DepartementId",
                        column: x => x.DepartementId,
                        principalTable: "Departements",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Tasks_TasksLevels_TasksLevelId",
                        column: x => x.TasksLevelId,
                        principalTable: "TasksLevels",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserDepartments", x => new { x.DepartementId, x.UserId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserDepartments_Departements_DepartementId",
                        column: x => x.DepartementId,
                        principalTable: "Departements",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_VendorRatings_Companies_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VendorSkills", x => x.Id);
                    table.ForeignKey(
                        name: "FK_VendorSkills_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_VendorSkills_Skills_SkillId",
                        column: x => x.SkillId,
            ...
            migrationBuilder.CreateTable(
                name: "SubscriptionTypeAttachments",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    SubscriptionTypeAttachmentMappingId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SubscriptionTypeAttachments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SubscriptionTypeAttachments_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SubscriptionTypeAttachments_SubscriptionTypeAttachmentMappings_SubscriptionTypeAttachmentMappingId",
                        column: x => x.SubscriptionTypeAttachmentMappingId,
                        principalTable: "SubscriptionTypeAttachmentMappings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TasksStatusId = table.Column<int>(type: "int", nullable: true),
                    OrderRequiredHours = table.Column<double>(type: "float", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Orders_TasksStatus_TasksStatusId",
                        column: x => x.TasksStatusId,
                        principalTable: "TasksStatus",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Quotations_AspNetUsers_VendorId",
                        column: x => x.VendorId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Categories_DepartementId",
                table: "Categories",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SubscriptionTypeAttachmentMappings_AttachmentId",
                table: "SubscriptionTypeAttachmentMappings",
                column: "AttachmentId");

            migrationBuilder.CreateIndex(
                name: "IX_SubscriptionTypeAttachmentMappings_SubscriptionTypeId",
                table: "SubscriptionTypeAttachmentMappings",
                column: "SubscriptionTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_SubscriptionTypeAttachments_SubscriptionTypeAttachmentMappingId",
                table: "SubscriptionTypeAttachments",
                column: "SubscriptionTypeAttachmentMappingId");

            migrationBuilder.CreateIndex(
                name: "IX_SubscriptionTypeAttachments_UserId",
                table: "SubscriptionTypeAttachments",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_SubscriptionTypesTerms_SubscriptionTypeId",
                table: "SubscriptionTypesTerms",
                column: "SubscriptionTypeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tasks_DepartementId",
                table: "Tasks",
                column: "DepartementId");

            migrationBuilder.CreateIndex(
                name: "IX_Tasks_TasksLevelId",
                table: "Tasks",
                column: "TasksLevelId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VendorRatings_CompanyId",
                table: "VendorRatings",
                column: "CompanyId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VendorSkills_SkillId",
                table: "VendorSkills",
                column: "SkillId");

            migrationBuilder.CreateIndex(
                name: "IX_VendorSkills_UserId",
                table: "VendorSkills",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_Wizards_WizardTypeId",
                table: "Wizards",
                column: "WizardTypeId");
        }
